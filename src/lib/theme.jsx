...
export function useC() {
  ...
  // (IA spec Void #121214 + Electric Blue #3b6ef7). Mirrors globals.css :root.
  return {
    d,
    text:         d ? '#ededef'                  : '#1a1a1a',
    text2:        d ? '#a4a4ad'                  : '#5d5b54',
    text3:        d ? '#6e6e78'                  : '#a4a097',
    text4:        d ? '#47474f'                  : '#ccc9c2',
    bg:           d ? '#121214'                  : '#ffffff',
    surface:      d ? '#18181a'                  : '#f6f5f4',
    card:         d ? '#18181a'                  : '#ffffff',
    cardBorder:   d ? '#232327'                  : 'rgba(0,0,0,0.07)',
    cardShadow:   d ? 'none'                     : '0 1px 3px rgba(15,15,15,0.06)',
    stat:         d ? '#1e1e21'                  : '#f6f5f4',
    statBorder:   d ? '#232327'                  : 'rgba(0,0,0,0.07)',
    statShadow:   d ? 'none'                     : '0 1px 3px rgba(15,15,15,0.05)',
    row:          d ? 'rgba(255,255,255,0.02)'   : 'rgba(0,0,0,0.02)',
    rowBorder:    d ? '#232327'                  : 'rgba(0,0,0,0.06)',
    subtle:       d ? '#18181a'                  : 'rgba(0,0,0,0.02)',
    subtleBorder: d ? '#232327'                  : '#e5e3df',
    headerBg:     d ? '#121214'                  : '#ffffff',
    headerBorder: d ? '#232327'                  : '#e5e3df',
    inputBg:      d ? '#1e1e21'                  : '#ffffff',
    inputBorder:  d ? '#2e2e34'                  : '#c8c4be',
    thinkingBg:   d ? 'rgba(255,255,255,0.02)'   : 'rgba(0,0,0,0.02)',
    thinkingBorder: d ? '#232327'                : '#e5e3df',
    // New tokens
    navy:         '#0c1428',
    navyMid:      d ? '#111d3a'                  : '#0c1428',
    surface2:     d ? '#1e1e21'                  : '#efeeec',
    surface3:     d ? '#242428'                  : '#e8e6e3',
    hairline:     d ? '#232327'                  : '#e5e3df',
    hairlineStrong: d ? '#2e2e34'                : '#c8c4be',
  };
}
